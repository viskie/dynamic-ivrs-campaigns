            ...
            <div class="widget_inside">
        				...
        				<div class="widget clearfix">
                    		<div class="widget_inside">
                    			<div class="form" style="border:none" >
                                	<div id="loading1" style="display:none; text-align:center;"><img src="img/loading.gif" /></div>
                                    ...
                                    <div class="clearfix no_border less_padding">                        
                            			<label>Postback Link (URL)<span class="mandatory">*</span></br>( offer_id is required in url )</label>
                            			<div class="input">
                                   ...
                                   <div class="clearfix no_border less_padding">                        
                                    ...
                                    <div class="clearfix no_border less_padding">                        
                            			<label>Call Conversion only in Days (in days)<span class="mandatory">*</span></label>
                            			<div class="input">
                                        	<input type="text"  id="call_conversion_days" name="call_conversion_days" maxlength="" class="xlarge" value="<?php if(isset($data['arr_ivrs'])){ echo $data['arr_ivrs']['call_conversion_days']; } ?>"/>                                       		
                            			</div>
                        			</div>
               ...
               <div id="tab-3">
                    <div class="row">
                        <div class="widget clearfix">
                            <div class="widget_inside">
                            	<div id="loading3" style="display:none;text-align:center;"><img src="img/loading.gif" /></div>
                                <div class="form" style="border:none" >
                                   <!-- <div class="clearfix no_border less_padding">                        
                ...
                <div id="tab-4">
                    <div class="row">
                        <div class="widget clearfix">
                            <div class="widget_inside">
                            	<div id="loading4" style="display:none;text-align:center;"><img src="img/loading.gif" /></div>
                                <div class="form" style="border:none" >
                                    <div class="clearfix no_border less_padding">                        
	   ...
	   $('#start_action').change(function(){
			...
			if($('#start_action option:selected').val() == "2")
			{
				start_string = '<div class="clearfix no_border less_padding">\
								...
								<div class="clearfix no_border less_padding">\
									<div class="input">\
										Phone number : <input type="text" id="" name="details[call_forword_no]" value=""/>\
									</div>\
								</div>'; 
		...
		for(var i=1; i<=no_of_keys; i++)
		{
			...
			ivr_string += '<div class="ivr_content">\
								...
								<div class="forward_call">\
									<div class="clearfix no_border less_padding">\
										<div class="input">Phone number : <input type="text" id="" name= "'+str_name+'[details][call_forword_no]"  value=""/>\
									</div>\
								</div>\
							</div></div>\
